...
# Set path
SONYC_UST_PATH=/home/hounie/audio/urban-sound-tagging-baseline/sonyc-mavd
...
python3 evaluate_predictions.py $exp_folder/output_mean.csv $SONYC_UST_PATH/data/annotations.csv $SONYC_UST_PATH/data/dcase-ust-taxonomy.yaml baseline sonyc-mavd
...
# Evaluate model based on AUPRC metric
python3 evaluate_predictions.py $exp_folder/output_mean.csv $SONYC_UST_PATH/data/annotations.csv $SONYC_UST_PATH/data/dcase-ust-taxonomy.yaml baseline_coarse sonyc-mavd
