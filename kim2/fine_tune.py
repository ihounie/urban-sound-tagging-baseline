...
from model_architecture import MyCNN, MyCNN_fine
...
def train(annotation_path, taxonomy_path, mel_dir, models_dir, output_dir, pretrained_dir, label_mode, 
		freeze, batch_size, num_epochs, learning_rate, patience):
	"""
	...
	conv_weights_path = os.path.join(pretrained_dir)
